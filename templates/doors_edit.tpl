{config_load file='smarty.conf'}
	...
	<title>{#appnamefull#} | Edit door</title>
...
{include file='body_start.tpl'}
  ...
  <div class="content-wrapper">
    <section class="content-header">
      <h1>
        Edit door
        <small>Edit new door to your organisation</small>
      </h1>
      <ol class="breadcrumb">
		...
		<form class="form-horizontal" method="POST">
			<fieldset>
				...
				<div class="form-group">
				  ...
				  <div class="col-md-4">
				   <select id="controller" name="controller" class="form-control input-md">
						...
						<option value="{$controller.id}" {if $door.controller eq $controller.id}selected{/if}>{$controller.name} ({$controller.building_name})</option>
			                {foreachelse}
				...
				<div class="form-group">
				  ...
				  <div class="col-md-8">
				    <button id="submit" name="submit" class="btn btn-success">Edit door</button>
